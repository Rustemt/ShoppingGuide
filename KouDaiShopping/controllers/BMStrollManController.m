...
@interface BMStrollManController ()<UITableViewDelegate,UITableViewDataSource,JDRequestDelegate>
{
    JDClient   *jdClient;
...
@implementation BMStrollManController
...
- (void)viewDidLoad
{
    ...
    [jdClient requestWithMethodName:@"jingdong.ware.stroll.manchannel.list.get" andParams:paramsDic andHttpMethod:@"POST" andDelegate:self];
