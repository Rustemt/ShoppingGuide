...
#import "BMDynmicCell.h"

@interface BMMyDynmicController ()<UITableViewDelegate,UITableViewDataSource>
@property (strong, nonatomic)  UITableView *myTalbeView;

@end

@implementation BMMyDynmicController
...
- (void)viewDidLoad
{
    ...
    [_myTalbeView registerNib:[UINib nibWithNibName:@"BMDynmicCell" bundle:nil] forCellReuseIdentifier:@"BMDynmicCell"];
...
{
    BMDynmicCell *cell = [tableView dequeueReusableCellWithIdentifier:@"BMDynmicCell" forIndexPath:indexPath];
