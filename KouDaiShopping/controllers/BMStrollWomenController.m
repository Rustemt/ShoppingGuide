...
@interface BMStrollWomenController ()<UITableViewDelegate,UITableViewDataSource,JDRequestDelegate>
{
    JDClient   *jdClient;
...
@implementation BMStrollWomenController
...
- (void)viewDidLoad
{
    ...
    //分页大小
    [paramsDic setObject:@"10" forKey:@"pagesize"];
    [jdClient requestWithMethodName:@"jingdong.ware.stroll.ladychannel.list.get" andParams:paramsDic andHttpMethod:@"POST" andDelegate:self];
